      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[600px] px-6 pt-6 pb-10 space-y-6">
        {!showThankYou && (
          <div className="flex justify-between items-center gap-4">
            <div className="h-[6px] bg-[#F2F2F2] rounded-md w-full">
              <div
        ...
        {!showThankYou && (
          <div className="">
            <h2 className="text-lg font-bold text-[#313131]">{title}</h2>
          </div>
        )}
        ...
        <div className="">
          {!showThankYou ? (
            <>
              {currentQuestion && (
                <div className="mb-6">
                  <p className="font-medium text-[#292929] mb-8">{currentQuestion.question}</p>
                    ...
                    <div className="space-y-4">
                      {currentQuestion.options?.map((option) => (
                        <label key={option} className="flex items-center gap-2 cursor-pointer">
                          ...
                          />
                          <span className="text-[#292929]">{option}</span>
                        </label>
                      ))}
                    </div>
                  )}
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-[#222222] mb-3">Thank You for Sharing!</h3>
              <p className="text-[#222222] mb-6 leading-[100%]">
