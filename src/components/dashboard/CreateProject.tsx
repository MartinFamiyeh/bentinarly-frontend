  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-[600px] px-6 pt-6 pb-10 space-y-6">
        <p className="font-bold text-2xl leading-none tracking-normal dark:text-gray-100">New Project</p>
        <p className="font-medium text-[16px] leading-none dark:text-gray-300">Give a name your new project</p>
        <input
          type="text"
          value={name}
        ...
        <div className="flex gap-4">
          <button
            onClick={onClose}
            disabled={loading}
            className="px-6 py-2 rounded text-[#696969] dark:text-gray-300 bg-[#F4F4F4] dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 w-full transition-all duration-300 disabled:opacity-50">
            Cancel
          </button>
          <button
