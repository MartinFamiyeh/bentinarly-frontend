...
const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <div className="shadow-sm p-4 bg-white rounded-tl-xl">
      <div className="flex justify-between items-center mb-4">
        <h1 className="font-semibold text-xl text-[#292929]">All Surveys</h1>
        ...
        <div className="relative w-full max-w-md">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-2.5 border border-[#E5E7EB] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FE5102]/30 text-sm text-[#292929] placeholder:text-[#696969]"
          />
        </div>
      </div>
      ...
      <div className="flex justify-between items-center w-full">
            ...
            <button
              ...
              className={`flex-shrink-0 px-4 py-1.5 rounded-lg text-sm transition-colors ${
                activeFilter === filter
                  ...
                  : "text-[#696969] hover:bg-[#FAFAFA] font-medium"
              }`}>
              {filter}
            </button>
          ))}
        ...
        <div className="relative shrink-0" ref={sortRef}>
          <button
            ...
            className="flex items-center gap-2 text-sm text-[#292929] hover:text-gray-800 border-l border-[#E5E7EB] pl-4">
